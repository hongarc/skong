---
name: git
description: "Git operations: clean branches, create releases/tags, sync protected branches. Triggers on: git clean, git release, create tag, prune branches. NOT for: regular git commits, branching, or daily git workflow."
