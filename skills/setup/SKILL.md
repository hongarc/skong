...
Available skills:
1. auto          — full workflow: research → propose → implement → review → commit
2. pr            — PR ops: auto review+fix+push, manual review, fix comments
3. git           — git ops: clean branches, create releases/tags
4. proposal      — technical proposals for lead
5. implement     — implement tasks
6. research      — research with reports
7. deploy        — local/vercel/aws
8. skill-writer  — create/edit skills
...
**Copy commands** (only these — most skills are called directly, no command file needed):
- Always: `learn.md`
- If pr selected: `pr.md`
- If git selected: `git.md`
