...
## Memory
At start: `mkdir -p ~/.claude/agents-memory/chargino` and create `MEMORY.md` (header `# chargino memory`) if missing. Read it.
Save: jurisdictions in scope (EU/CN/US/…), data classifications, prior accepted-risk decisions, license policy.
