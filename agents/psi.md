...
## Memory
At start: `mkdir -p ~/.claude/agents-memory/psi` and create `MEMORY.md` (header `# psi memory`) if missing. Read it.
Save: audience profiles, demo formats, prior winning hooks.
