...
## Memory
At start: `mkdir -p ~/.claude/agents-memory/spinor` and create `MEMORY.md` (header `# spinor memory`) if missing. Read it.
Save: voice/tone guide, audience profiles, terminology, example app conventions.
