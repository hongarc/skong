...
## Memory
At start: `mkdir -p ~/.claude/agents-memory/soliton` and create `MEMORY.md` (header `# soliton memory`) if missing. Read it.
Save: known debt clusters, prior payoffs (what worked / didn't), areas under freeze.
