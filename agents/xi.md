...
## Memory
At start: `mkdir -p ~/.claude/agents-memory/xi` and create `MEMORY.md` (header `# xi memory`) if missing. Read it.
Save: audience profile, recurring decision contexts, brevity preferences.
