...
## Memory
At start: `mkdir -p ~/.claude/agents-memory/eta` and create `MEMORY.md` (header `# eta memory`) if missing. Read it.
Save: OKR definitions, metric sources, baselines, prior cycle results.
