---
name: deploy
description: "Use when deploying projects. Handles local dev, Vercel deployments. For AWS, prepares handoff to AWS team. Triggers on: deploy, ship, publish, release, vercel, local dev."
version: 1.0.0
